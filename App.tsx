...
// Removed redundant declare global block as types are pre-configured in the environment.
// Following @google/genai guidelines to avoid manual API key management UI.
          ...
          <div className="flex flex-col items-center justify-center h-[50vh] text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-400 max-w-[240px] mx-auto font-medium">
                Toda grande jornada começa com uma simples nota.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8">
            <span className="flex items-center gap-2.5">
              <i className="fas fa-bolt text-amber-400"></i> Gemini Flash Free
            </span>
            <span className="flex items-center gap-2.5">
              <i className="fas fa-cloud-sun text-indigo-400"></i> Deploy Vercel
            </span>
          </div>
        </div>
      </footer>
